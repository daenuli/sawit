...
function Header()
{
	...
	$this->SetY(10);
	$this->Cell(0,10,'laporan PELABUHAN per HARI 00-00-00 - 00-00-00',0,0,'R');
	// Line break
	$this->Ln(12);
...
function ImprovedTable()
{
	...
	// Data
	$nomor = 0;
	$qry = mysql_query("select * from penimbanganTambang");
	while($r = mysql_fetch_array($qry)){
		...
		$this->Cell($w[8],6,$r['bruto'],'LR',0,'R');
		$this->Cell($w[9],6,$r['tara'],'LR',0,'R');
		$this->Cell($w[10],6,$r['netto'],'LR',0,'R');
		$this->Ln();
	}
	// Closing line
