<?php include "config/fungsi_form.php"; ?>
	...
	inputFormDate("akhir","Akhir"); ?>
                                    ...
                                    <div class="col-sm-2">
                                      ...
                                      <?PHP $qrySupplier = mysql_query("select distinct nmRelasi from penimbangantbs_d"); 
              ...
              <div class="col-sm-offset-3 col-sm-9">
                <button type="submit" class="btn btn-primary" onclick="kirimLaporanSleksi('cetak_laporan_tbs.php?laporan=tanggal')">Harian</button>
                <button type="submit" class="btn btn-primary" onclick="kirimLaporanSleksi('cetak_laporan_tbs.php?laporan=kendaraan')">Kendaraan</button>
                <button type="submit" class="btn btn-primary" onclick="kirimLaporanSleksi('cetak_laporan_tbs.php?laporan=barang')">Material</button>
                <button type="submit" class="btn btn-primary" onclick="kirimLaporanSleksi('cetak_laporan_tbs.php?laporan=relasi')">Supplier</button>              
              </div>
              </div>
						   </form>
								</div>
